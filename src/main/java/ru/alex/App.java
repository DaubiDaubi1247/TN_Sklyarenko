...
public class App 
{
    public static void main( String[] args ) {
        ...
        System.out.println(ListHandler.getSumByFilterCondition(numList, moreThanZero));

        Predicate<Integer> lessThanZero = num -> num < 0;
        System.out.println(ListHandler.getSumByFilterCondition(numList, lessThanZero));
    }
